...
public class PreferenceScreen implements Screen {
    ...
    public void show() {
        ...
        movingUpTf.setMaxLength(1);
        movingUpTf.setAlignment(Align.center);
        movingLeftTf = new TextField(gamePreferences.getMovingLeftKey(), skin);
        movingLeftTf.setMaxLength(1);
        movingLeftTf.setAlignment(Align.center);
        movingDownTf = new TextField(gamePreferences.getMovingDownKey(), skin);
        movingDownTf.setMaxLength(1);
        movingDownTf.setAlignment(Align.center);
        movingRightTf = new TextField(gamePreferences.getMovingRightKey(), skin);
        movingRightTf.setMaxLength(1);
        movingRightTf.setAlignment(Align.center);
        attackTf = new TextField(gamePreferences.getAttack1Key(), skin);
        attackTf.setMaxLength(1);
        attackTf.setAlignment(Align.center);
        mapTf = new TextField(gamePreferences.getMapKey(), skin);
        mapTf.setMaxLength(1);
        mapTf.setAlignment(Align.center);
        questTf = new TextField(gamePreferences.getQuestKey(), skin);
        questTf.setMaxLength(1);
        questTf.setAlignment(Align.center);
    ...
    private String saveChanges() {
        ...
        int nbKeys = 0;
        keys.add(movingUp.toUpperCase());
        nbKeys++;
        keys.add(movingDown.toUpperCase());
        nbKeys++;
        keys.add(movingLeft.toUpperCase());
        nbKeys++;
        keys.add(movingRight.toUpperCase());
        nbKeys++;
        keys.add(attack1.toUpperCase());
        nbKeys++;
        keys.add(map.toUpperCase());
        nbKeys++;
        keys.add(quest.toUpperCase());
        nbKeys++;
